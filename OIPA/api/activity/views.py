...
from api.generics.views import DynamicDetailCRUDView, DynamicDetailView, \
    DynamicListCRUDView, DynamicListView
...
class ActivityAggregations(AggregationView):
    ...
    allowed_groupings = (
        ...
        GroupBy(
            ...
            renamed_fields=(
                "participating_organisation", "participating_organisation_ref"),
...
class ActivityList(DynamicListView):
    ...
    - `reporting_organisation_type` (*optional*): Comma separated list of reporting organisation type codes.
    ...
    queryset = Activity.objects.all()
    filter_backends = (
        SearchFilter, DjangoFilterBackend, DistanceFilter, filters.RelatedOrderingFilter,)
    ...
    def get_queryset(self):
        ...
        try:
            return iati_models.Activity.objects.get(
                pk=pk).participating_organisations.all()
        except Activity.DoesNotExist:
            return None


class ActivityParticipatingOrganisationDetail(UpdateActivitySearchMixin,
                                              RetrieveUpdateDestroyAPIView):
    serializer_class = activity_serializers.ParticipatingOrganisationSerializer
...
class ActivityRecipientCountryList(UpdateActivitySearchMixin, ListCreateAPIView):
    ...
    def get_queryset(self):
        ...
        try:
            return iati_models.Activity.objects.get(
                pk=pk).activityrecipientcountry_set.all()
        except Activity.DoesNotExist:
            return None
...
class ActivityRecipientRegionList(UpdateActivitySearchMixin, ListCreateAPIView):
    ...
    def get_queryset(self):
        ...
        try:
            return iati_models.Activity.objects.get(
                pk=pk).activityrecipientregion_set.all()
        except Activity.DoesNotExist:
            return None
...
class ActivityPolicyMarkerList(ListCreateAPIView):
    ...
    def get_queryset(self):
        pk = self.kwargs.get('pk')
        try:
            return iati_models.Activity.objects.get(pk=pk).activitypolicymarker_set.all()
        except Activity.DoesNotExist:
            return None
...
class ActivityPlannedDisbursementList(ListCreateAPIView):
    ...
    def get_queryset(self):
        pk = self.kwargs.get('pk')
        try:
            return iati_models.Activity.objects.get(pk=pk).planned_disbursements.all()
        except Activity.DoesNotExist:
            return None
...
class ActivityDocumentLinkList(UpdateActivitySearchMixin, ListCreateAPIView):
    ...
    def get_queryset(self):
        pk = self.kwargs.get('pk')
        try:
            return iati_models.Activity.objects.get(pk=pk).documentlink_set.all()
        except Activity.DoesNotExist:
            return None
...
class ActivityRelatedActivityList(ListCreateAPIView):
    ...
    def get_queryset(self):
        pk = self.kwargs.get('pk')
        try:
            return iati_models.Activity.objects.get(pk=pk).related_activities.all()
        except Activity.DoesNotExist:
            return None
...
class ResultIndicatorList(ListCreateAPIView):
    ...
    def get_queryset(self):
        ...
        try:
            return iati_models.Activity.objects.get(pk=pk).result_indicators.all()
        except Activity.DoesNotExist:
            return None
...
class ResultIndicatorReferenceList(ListCreateAPIView):
    ...
    def get_queryset(self):
        ...
        try:
            return iati_models.Activity.objects.get(
                pk=pk).result_indicator_references.all()
        except Activity.DoesNotExist:
            return None
...
class ResultIndicatorPeriodList(ListCreateAPIView):
    ...
    def get_queryset(self):
        pk = self.kwargs.get('resultindicator_id')
        try:
            return iati_models.Activity.objects.get(pk=pk).result_indicator_periods.all()
        except Activity.DoesNotExist:
            return None
...
class ActivityConditionList(ListCreateAPIView):
    ...
    def get_queryset(self):
        pk = self.kwargs.get('pk')
        try:
            return iati_models.Activity.objects.get(pk=pk).conditions.condition_set.all()
        except Activity.DoesNotExist:
            return None
